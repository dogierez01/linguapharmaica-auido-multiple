...
// ==========================================
// 3. CORE LOGIC (Clean Audio Engine)
// ==========================================

// Force Chrome to load its voices into memory the second the page opens
window.speechSynthesis.onvoiceschanged = function() {
    window.speechSynthesis.getVoices();
};

function playTurkishAudio(text) {
    // 1. Clear any stuck audio jams instantly
    ...
    // 3. Gently attach the Turkish voice if it is ready
